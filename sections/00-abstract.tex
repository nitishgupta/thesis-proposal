...
Going forward, I am focussing on two main directions -- (a) understanding and improving systematic generalization in such models, and (b) extending such models to achieve transfer of reasoning capabilities across domains and tasks by sharing modules and supervision.
The biggest challenge in pursuing this direction, and also what excites me the most, is trying to find a good middle-ground between the neatness of formal logic and fuzziness of reasoning over natural language.
